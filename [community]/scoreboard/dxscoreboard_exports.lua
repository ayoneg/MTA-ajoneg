...
scoreboardColumns = {
	...
	{ ["name"] = "name", ["width"] = 150, ["friendlyName"] = "Nick", ["priority"] = 2 },
	{ ["name"] = "player:frakcjaCODE", ["width"] = 60, ["friendlyName"] = "Frakcja", ["priority"]=3 },
	{ ["name"] = "player:orgShortNAME", ["width"] = 140, ["friendlyName"] = "Organizacja", ["priority"] = 4 },
	{ ["name"] = "player:reputacja", ["width"] = 60, ["friendlyName"] = "Reputacja", ["priority"]=5 },
	{ ["name"] = "player:PG", ["width"] = 35, ["friendlyName"] = "PG", ["priority"]=6 },
	{ ["name"] = "ping", ["width"] = 35,  ["friendlyName"] = "Ping", ["priority"] = MAX_PRIRORITY_SLOT }
}
resourceColumns = {}
...
function scoreboardResetColumns( forElement )
	...
	if forElement == getRootElement() then
		...
		if result then
			scoreboardAddColumn( "name", 300, "Nick" )
